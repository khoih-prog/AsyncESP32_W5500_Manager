...
void setup()
{
  ...
  AsyncESP32_W5500_Manager AsyncESP32_W5500_manager(&webServer, NULL, "AsyncCP-ParamsOnSW");
#else
  AsyncDNSServer dnsServer;

  AsyncESP32_W5500_Manager AsyncESP32_W5500_manager(&webServer, &dnsServer, "AsyncCP-ParamsOnSW");
#endif
